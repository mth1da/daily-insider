...
<!--header_utilisateur-->
<header>
    <?php include_once('config/config_lang.php'); ?> <!--on importe les variables selon la langue-->
    <nav>
        <a href="accueil.php"> <img class="logo" src="img/logo.jpg" alt="logo du site"></a>
        <ul>
            <br><br>
            <li><?php echo $GLOBALS['acc'].$_SESSION['mail'] ; ?></li> <!--on affiche la variable $acc selon la langue, suivie de l'adresse mail indiquée grâce à la variable $_SESSION-->
            ...
            <li><a href="config/config_deconnexion.php"> <button class="comment"><span><?php echo $GLOBALS['logout'];?></span></button></a></li>
            <li><a href="favoris.php"> <input type="button" value="<?php echo $GLOBALS['favs'];?>" class="comment"></a></li>
        </ul>
    </nav>
    <div id="menu">
        <ul>
